    ...
    def run(self, m):
        ...
        # Join a group. #
            ...
            for id in self.bot.administration:
                if (input in self.bot.administration or input in self.bot.administration[id]['alias'] or input in self.bot.groups[id]['title']):
                    gid_to_join = id
                    break
            ...
            for rule in self.bot.administration[gid_to_join]['rules']:
                text += '\n %s. <i>%s</i>' % (i, rule)
                i += 1
            if not self.bot.administration[gid_to_join]['rules']:
        ...
        # Configures a group. #
            ...
            if not input:
                ...
                if not gid in self.bot.administration:
                    ...
                    db.reference('administration/%s/%s' % (self.bot.name, gid)).set(self.bot.administration[gid])
                ...
                if first_word(input) == 'add':
                    ...
                    if gid in self.bot.administration:
                        ...
                        db.reference('administration/%s/%s' % (self.bot.name, gid)).delete()
                    ...
                    if gid in self.bot.administration:
                        ...
                        db.reference('administration/%s/%s/alias' % (self.bot.name, gid)).set(self.bot.administration[gid]['alias'])
                    ...
                    if gid in self.bot.administration:
                        ...
                        db.reference('administration/%s/%s/motd' % (self.bot.name, gid)).set(self.bot.administration[gid]['motd'])
                        return self.bot.send_message(m, self.bot.trans['plugins']['administration']['strings']['set'] % m.conversation.title, extra={'format': 'HTML'})
                    else:
                        return self.bot.send_message(m, self.bot.trans['plugins']['administration']['strings']['not_added'] % m.conversation.title, extra={'format': 'HTML'})
                    ...
                    if gid in self.bot.administration:
                        ...
                        db.reference('administration/%s/%s/link' % (self.bot.name, gid)).set(self.bot.administration[gid]['link'])
                        return self.bot.send_message(m, self.bot.trans['plugins']['administration']['strings']['set'] % m.conversation.title, extra={'format': 'HTML'})
                    else:
                        return self.bot.send_message(m, self.bot.trans['plugins']['administration']['strings']['not_added'] % m.conversation.title, extra={'format': 'HTML'})
                    ...
                    if gid in self.bot.administration:
                        ...
                        db.reference('administration/%s/%s/public' % (self.bot.name, gid)).set(self.bot.administration[gid]['public'])
                        return self.bot.send_message(m, self.bot.trans['plugins']['administration']['strings']['set'] % m.conversation.title, extra={'format': 'HTML'})
                    else:
                        return self.bot.send_message(m, self.bot.trans['plugins']['administration']['strings']['not_added'] % m.conversation.title, extra={'format': 'HTML'})
    ...
    def always(self, m):
        ...
        if m.type == 'notification' and m.content == 'upgrade_to_supergroup':
            ...
            if from_id in self.bot.administration:
                ...
                db.reference('administration/%s/%s' % (self.bot.name, to_id)).set(self.bot.administration[to_id])
